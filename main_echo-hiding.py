...
from src.stego_audio.embed_echo_audio import embed_echo_audio
from src.stego_audio.extract_echo_audio import extract_echo_audio
...
if __name__ == "__main__":
    ...
    if is_audio(cover_path):
        embed_echo_audio(cover_path, ciphertext, stego_path)
    ...
    # 5. Extract & decrypt
    if is_audio(cover_path):
        extracted = extract_echo_audio(stego_path, len(ciphertext))
    else:
